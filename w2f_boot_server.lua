-- W2F branded boot banner (server-side, no cross-resource imports).
local function w2fBannerServer(name, desc)
...
AddEventHandler('onResourceStart', function(rName)
    ...
    w2fBannerServer('W2F-Phone', 'Advanced Qbox smartphone OS')
end)
